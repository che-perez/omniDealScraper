...
const SOURCE = "cheapgraphicnovels";
 ...
 */
async function scrapeCategoryWithPagination(startUrl) {
    const allItems = [];
    let browser = null;
    try {
        // Launch browser
 ...
 */
export async function scrapeCheapGraphicNovels() {
    const allItems = [];
